 ...
 *
 *  @author  Senior Engineer (30 years Java)
 */
public class Order implements Serializable {
    ...
    private Long id;
    private String orderNumber;      // Human-readable: "ORD-20240101-0001"
    private Long userId;
    ...
    private String statusReason;     // reason for cancellation etc.
    ...
    private int priority;            // 1=normal, 2=express, 3=urgent (used in queue)
    ...
    /** Factory method — clean way to create a new order */
    ...
    public void recalculate() {
        ...
        this.finalAmount = totalAmount.subtract(
    ...
    public String toString() {
        return "Order{id=" + id + ", orderNumber='" + orderNumber +
                "', status=" + status + ", finalAmount=" + finalAmount + "}";
    }
}